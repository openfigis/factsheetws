...
/**
 * TODO not used yet this class. This one has been copied from the JaxB reference implementation.
 * 
 * 
...
class NamespacePrefixMapperImpl extends NamespacePrefixMapper {
	...
	public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix) {
		...
		if ("http://www.fao.org/fi/figis/devcon/webservice".equals(namespaceUri))
			return "fiws";
	 ...
	 * <p>
	 * By default, the JAXB RI produces namespace declarations only when they are necessary, only at where they are
	 * used. Because of this lack of look-ahead, sometimes the marshaller produces a lot of namespace declarations that
	 * look redundant to human eyes. For example,
	 * 
	 * <pre>
	 * <xmp>
	 * <?xml version="1.0"?>
	 ...
	 * </pre>
	 * <p>
	 * If you know in advance that you are going to use a certain set of namespace URIs, you can override this method
	 * and have the marshaller declare those namespace URIs at the root element.
	 * <p>
	 ...
	 * 
	 * @return A list of namespace URIs as an array of {@link String}s. This method can return a length-zero array but
	 *         not null. None of the array component can be null. To represent the empty namespace, use the empty string
	 *         <code>""</code>.
	 * 
	 * @since JAXB RI 1.0.2
	 */
